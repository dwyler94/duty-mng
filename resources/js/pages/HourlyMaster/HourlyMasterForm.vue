            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-md-2">
                    <div class="d-flex is-invalid align-items-center">
                        <input type="number" class="form-control p-1 mr-2" v-model="data.startTimeHour" min="0" max="23" :class="{'is-invalid' : errors.startTime}" @change="errors.startTime = null">
                        :
                        <input type="number" class="form-control p-1 ml-2" v-model="data.startTimeMinute" min="0" max="59" :class="{'is-invalid' : errors.startTime}" @change="errors.startTime = null">
                    </div>
                ...
                <div class="col-md-2">
                    <div class="d-flex is-invalid align-items-center">
                        <input type="number" class="form-control p-1 mr-2" v-model="data.endTimeHour" min="0" max="23" :class="{'is-invalid' : errors.endTime}" @change="errors.endTime = null">
                        :
                        <input type="number" class="form-control p-1 ml-2" v-model="data.endTimeMinute" min="0" max="59" :class="{'is-invalid' : errors.endTime}" @change="errors.endTime = null">
                    </div>
