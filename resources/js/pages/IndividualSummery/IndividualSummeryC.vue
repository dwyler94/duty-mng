            ...
            <table class="table table-bordered table-striped table-kintai table-head-fixed table-hover w-3100-px">
                <thead class="text-center text-white">
                    <tr>
                        ...
                        <th rowspan="2" class="align-middle">残業時間</th>
                        ...
                        <th rowspan="2" class="align-middle p-0">確認</th>
                    </tr>
                    ...
                    <tbody class="text-center header-fix-x-tr">
                        <tr v-for="(dayAttendance, index) in attendance" :key="dayAttendance.id">
                            <template  v-if="editMode && selectedIndex == index">
                                ...
                                <td>{{dayAttendance.overtimeWorkingHours ? (dayAttendance.overtimeWorkingHours / 60).toFixed(2) : '-'}}</td>
            ...
            <table class="table table-bordered">
                <tbody class="text-center">
                    <tr class="top-green text-white">
                        ...
                        <th class="align-middle">残業外<br>労働時間[土曜]</th>
                    ...
                    <tr class="heavy-green text-white">
                        ...
                        <td>{{(total.actualWorkingHoursSaturday / 60).toFixed(2)}}時間</td>
                        <td>{{(total.overtimeHoursWeekdays / 60).toFixed(2)}}時間</td>
                        <td>{{(total.overtimeHoursSaturday / 60).toFixed(2)}}時間</td>
